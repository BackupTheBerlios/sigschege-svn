...
TimingScene::TimingScene(QObject *parent) : QGraphicsScene(parent) {

	setSceneRect(0, 0, m_LayoutData.get_col_0_width() + m_LayoutData.get_col_1_width(), 100);
...
void TimingScene::setLabelWidth(unsigned int width) {
	long scene_width = getLayoutData()->get_col_0_width() + getLayoutData()->get_col_1_width();
